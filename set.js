...
global.caption = "*©2025 ʟɪɢʜᴛᴍᴋᴇʀ ᴍᴅ ᴠ20*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴩᴏᴡᴇʀᴇᴅ ʙy ʟɪɢʜᴛᴍᴀᴋᴇʀ ᴏꜰᴄ*"; // Input Yours custom...(Maintain font for Flow)
...
OWNER_NAME: process.env.OWNER_NAME || "ʟɪɢʜᴛᴍᴀᴋᴇʀ ᴛᴇᴄʜ", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "ʟɪɢʜᴛᴍᴀᴋᴇʀ ᴛᴇᴄʜ", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "ʟɪɢʜᴛᴍᴀᴋᴇʀ ᴛᴇᴄʜ💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "𝗟𝗶𝗴𝗵𝘁 𝗠𝗱", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://i.ibb.co/48zY5P4/116cd268195eb2f3.jpg", // You can Replace with yours...
