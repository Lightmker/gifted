...
global.caption = "*©²⁰²⁵ ᴺᵗᵃⁿᵈᵒ ⱽ¹💙*"; // Input Yours custom...(Maintain font for Flow)
global.api = "https://api.giftedtech.my.id/docs/"; // DO NOT Change this...
...
OWNER_NAME: process.env.OWNER_NAME || "ᴺᵗᵃⁿᵈᵒ ᵀᵉᶜʰ", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "ᴺᵗᵃⁿᵈᵒ ᵀᵉᶜʰ", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "©²⁰²⁵ ᴺᵗᵃⁿᵈᵒ ⱽ¹💙", // Added // Input Yours custom...
PREFIX: process.env.PREFIX || ".",
API_KEY: process.env.API_KEY || "©²⁰²⁵ ᴺᵗᵃⁿᵈᵒ ⱽ¹💙", // Replace with your unlimited api key
